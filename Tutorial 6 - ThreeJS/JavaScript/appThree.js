...
// Variável que é reponsável por controlar o tempo da aplicação
var relogio = new THREE.Clock();

// Variável com o objeto responsável por importar ficheiros FBX
var importer = new THREE.Loader();

importer.load('./Objetos/Samba Dancing.fbx', function(object) {

    // 0 mixerAnimação é inicializado tendo em conta o objeto importado
    mixerAnimacao = new THREE.AnimationMixer(object);
    
    // object.animations é um array com todas as animações que o objeto trás quando é importado.
    // 0 que nós fazemos, é criar uma ação de animação tendo em conta a animação que é pretendida
    ...
    // 0 primeiro e único parâmetro da função é uma nova função que deve ser chamada para cada
